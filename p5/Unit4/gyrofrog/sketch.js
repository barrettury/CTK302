...
function Car() {
  ...
  this.display = function() {
    ...
    if (this.b == 0) image(oran, this.pos.x, this.pos.y);
    if (this.b == 1) image(pecha, this.pos.x, this.pos.y);
    if (this.b == 2) image(sitrus, this.pos.x, this.pos.y);
    if (this.b == 3) image(razz, this.pos.x, this.pos.y);
